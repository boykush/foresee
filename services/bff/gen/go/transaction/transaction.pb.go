...
func (HealthCheckResponse_ServingStatus) EnumDescriptor() ([]byte, []int) {
	return file_transaction_transaction_proto_rawDescGZIP(), []int{1, 0}
}
...
const file_transaction_transaction_proto_rawDesc = "" +
	"\n" +
	"\x1dtransaction/transaction.proto\x12\x0etransaction.v1\".\n" +
	...
	"\vHealthCheck\x12\".transaction.v1.HealthCheckRequest\x1a#.transaction.v1.HealthCheckResponseB\xc9\x01\n" +
