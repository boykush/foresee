...
const file_transaction_transaction_proto_rawDesc = "" +
	"\n" +
	"\x1dtransaction/transaction.proto\x12\x0etransaction.v1\x1a\x1bgrpc/health/v1/health.proto2l\n" +
	"\x12TransactionService\x12V\n" +
	"\vHealthCheck\x12\".grpc.health.v1.HealthCheckRequest\x1a#.grpc.health.v1.HealthCheckResponseB\xc9\x01\n" +
